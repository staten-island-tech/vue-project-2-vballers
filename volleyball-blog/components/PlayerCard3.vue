<template>
    <div>
        <Nuxt-link to="/donny" class="box">
            ...
            <div class="container-text player-number">5</div>
            <div class="container-text player-name">Donny Lau</div>
            <div class="bio">
                <div class=" player-position">Outside / </div>
                <div class=" player-height"> 6'2 / </div>
